...
const sectionStyle: CSSProperties = { padding: 16, border: "1px solid #292929", borderRadius: 15, background: "#101010" };
...
const badgeStyle: CSSProperties = { display: "inline-flex", padding: "4px 8px", border: "1px solid", borderRadius: 999, fontSize: 11, lineHeight: 1, fontWeight: 800, whiteSpace: "nowrap" };
